...
Meteor.methods({
	...
	updateInsert_data: function(dataValues) {
	 	...
	 	{
	 		RoadActivity.update({_id: dataValues[0]}, {$set: {Category: dataValues[1], Status: dataValues[2], Direction: dataValues[3], Road: dataValues[4], CountyCode: dataValues[5], DistrictNumber: dataValues[6], Latitude: dataValues[7], Longitude: dataValues[8], ActivityStartDateTime: dataValues[9], ActivityEndDateTime: dataValues[10], ActivityCreationDateTime: dataValues[11], ActivityLastModifiedDateTime: dataValues[12], StartMile: dataValues[13], StartMileDescription: dataValues[14], EndMile: dataValues[15], EndMileDescription: dataValues[16], Description: dataValues[17], DetourDescription: dataValues[18]}});
	 		console.log("update");
	 	}
